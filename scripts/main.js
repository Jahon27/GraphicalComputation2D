...
canvas.addEventListener("click", function (e) {
  // При клике меняем размер и позицию turtlePlanet
  const turtlePlanetElement = document.getElementById("turtlePlanet");
  turtlePlanetElement.style.width = "140px"; // Новый радиус
  turtlePlanetElement.style.height = "140px"; // Новый радиус
  turtlePlanetElement.style.left = "210px"; // Новая горизонтальная позиция
  turtlePlanetElement.style.top = "210px"; // Новая вертикальная позиция

  const rabbitPlanetElement = document.getElementById("rabbitPlanet");
  rabbitPlanetElement.style.width = "230px"; // Новый радиус
  rabbitPlanetElement.style.height = "230px"; // Новый радиус
  rabbitPlanetElement.style.left = "1010px"; // Новая горизонтальная позиция
  rabbitPlanetElement.style.top = "310px"; // Новая вертикальная позиция

  const penguinPlanetElement = document.getElementById("penguinPlanet");
  penguinPlanetElement.style.width = "180px"; // Новый радиус
  penguinPlanetElement.style.height = "180px"; // Новый радиус
  penguinPlanetElement.style.left = "610px"; // Новая горизонтальная позиция
  penguinPlanetElement.style.top = "410px"; // Новая вертикальная позиция
});
